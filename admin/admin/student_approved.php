...
<head>
    ...
    <title>Approved Student</title>
 <?php include "header.php";?>


<?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from user where Status ='approved' and User_type='Student' ") or die(mysqli_error($connect));
...
?> 
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Approve Student Details</h3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <td><a href="reg_disapprove.php?id=<?=$id ?>" class="fa fa-thumbs-o-down fa-2x text-danger" type="submit" name="view"  data-placement="bottom" title="disapprove" data-toggle="tooltip"></a></td>
                                                        
                                                        <td>
                                                        <a href="user_view.php?id=<?=$id ?>" class="fa fa-eye fa-2x text-info" type="submit" name="view"  data-placement="bottom" title="view" data-toggle="tooltip" ></a>
