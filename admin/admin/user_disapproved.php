...
<head>
    ...
    <title>Disapproved Users Details</title>
    <?php include "header.php";?>

    <?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from user where Status ='disapproved' and User_type='Public' ") or die(mysqli_error($connect));

    ?> 
   

                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Disapproved Users Details</h3>
