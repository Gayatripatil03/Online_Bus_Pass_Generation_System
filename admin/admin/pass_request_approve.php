...
<head>
    ...
    <title>Approved Pass Details</title>
 <?php include "header.php";?>


<?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from pass_details where Status ='approved'  ") or die(mysqli_error($connect));
...
?> 
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Approve Pass Details </h3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <a href="pass_disapprove.php?id=<?=$id ?>" class="fa fa-thumbs-o-down fa-2x text-danger" type="submit" name="view"  data-placement="bottom" title="disapprove" data-toggle="tooltip" ></a></td>
