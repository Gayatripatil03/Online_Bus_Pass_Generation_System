...
<?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from user where Status ='approved' and User_type='Public' ") or die(mysqli_error($connect));
...
?> 
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Approve Users Details</h3>
