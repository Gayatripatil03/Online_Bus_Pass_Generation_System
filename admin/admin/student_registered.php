...
<head>
    ...
    <?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from user where Status ='Not_approved' and User_type='Student' ") or die(mysqli_error($connect));
    ...
    ?> 
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Registered Student Details</h3>
                                            ...
                                            <tbody>
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <a href="reg_disapprove.php?id=<?=$id ?>" class="fa fa-thumbs-o-down fa-2x text-danger" type="submit" name="view"  data-placement="bottom" title="disapprove" data-toggle="tooltip" style="padding-left:10px"></a></td>
