...
<head>
    ...
    <title>Disapproved Pass Details</title>
 <?php include "header.php";?>


<?php
        include "config.php";
        $disp=mysqli_query($connect,"select * from pass_details where Status ='disapproved'  ") or die(mysqli_error($connect));

?> 

                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Disapproved Pass Details </h3>
